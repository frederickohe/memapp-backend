...
def send_money_direct(
    ...
    try:
        ...
        mtc_request = {
            ...
            "callback_url": "https://ymca-dcahe0a8cjecffcm.canadacentral-01.azurewebsites.netapi/api/v1/payment/callback",
            "trans_type": "MTC"
        }
...
def pay_bill_direct(
    ...
    try:
        ...
        blp_request = {
            ...
            "service_id": "4892",
            "ts": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
            "callback_url": "https://ymca-dcahe0a8cjecffcm.canadacentral-01.azurewebsites.net/api/v1/payment/callback",
            "trans_type": "BLP"
        }
