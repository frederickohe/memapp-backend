...
class ReceiptGenerator:
    def __init__(self):
        ...
        self.logo = self._load_icon("ymca_logo.png")
    ...
    def _generate_receipt(self, data: Dict[str, Any]) -> Image.Image:
        ...
        if self.logo:
            try:
                ...
                draw.text((80, y), "ymca", font=bold_fnt, fill=dark)
        ...
        draw.text((WIDTH // 2, HEIGHT - 80),
                  "This payment was made with ymca",
                  anchor="mm",
                  fill=label,
                  font=small_fnt)
    ...
    def _generate_loan_receipt(self, data: Dict[str, Any]) -> Image.Image:
        ...
        if self.logo:
            try:
                ...
                draw.text((80, y), "ymca", font=bold_font, fill=black_text)
        ...
        # -----------------------------------------
        draw.text((width // 2, height - 80),
                  "Manage your loan in the ymca app!",
                  anchor="mm",
                  fill=gray_text,
                  font=small_font)
